...
- (NSString *)setterForProperty:(ClassPropertiesObject *)property {
    ...
    if (property.isClass && (property.type == PropertyTypeDictionary || property.type == PropertyTypeClass)) {
        ...
        if (nil != property.referenceClass) {
            ...
            templateString = [templateString stringByReplacingOccurrencesOfString:@"{PROPERTYNAME}" withString:property.jsonName];
            ...
            templateString = [templateString stringByReplacingOccurrencesOfString:@"{JSONNAME}" withString:property.jsonName];
            templateString = [templateString stringByReplacingOccurrencesOfString:@"{PROPERTYNAME}" withString:property.jsonName];
            templateString = [templateString stringByReplacingOccurrencesOfString:@"{CLASSNAME}" withString:[property.jsonName capitalizeFirstCharacter]];
        ...
        setterString = [setterString stringByAppendingString:[NSString stringWithFormat:@"        this.%@ = ", property.jsonName]];
...
- (NSString *)getterForProperty:(ClassPropertiesObject *)property {
    NSString *getterMethod = [NSString stringWithFormat:@"    public %@ get%@() {\n        return this.%@;\n    }\n\n", [self typeStringForProperty:property], [property.jsonName capitalizeFirstCharacter], property.jsonName];
...
- (NSString *)setterMethodForProperty:(ClassPropertiesObject *)property {
    NSString *setterMethod = [NSString stringWithFormat:@"    public void set%@(%@ %@) {\n        this.%@ = %@;\n    }\n\n", [property.jsonName capitalizeFirstCharacter], [self typeStringForProperty:property], property.jsonName, property.jsonName, property.jsonName];
